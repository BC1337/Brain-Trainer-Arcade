...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/aim-trainer" | "/api" | "/api/auth" | "/api/auth/login" | "/api/auth/signup" | "/api/dashboard" | "/api/user" | "/api/user/highscore" | "/api/user/highscore/[game]" | "/chimp-test" | "/connections" | "/dashboard" | "/games" | "/login" | "/memory-trainer" | "/reaction-timer" | "/signup" | "/simon-says" | "/type-racer" | "/word-game" | "/word-game/how-to-play";
		RouteParams(): {
		...
		Pathname(): "/" | "/aim-trainer" | "/api/auth/login" | "/api/auth/signup" | "/api/dashboard" | `/api/user/highscore/${string}` & {} | "/chimp-test" | "/connections" | "/dashboard" | "/games" | "/login" | "/memory-trainer" | "/reaction-timer" | "/signup" | "/simon-says" | "/type-racer" | "/word-game" | "/word-game/how-to-play" | "/word-game/how-to-play/";
